...
var (
	...
	WelcomeMessage = "Hello! I'm your personal nutrition assistant!\nThis app uses the API provided generously by the folks\nat Nutritionix to help you find the most nutritional meals!"
